...
def recipe():
    ...
    '''The recipe package
     ...
     Imports pandas,DNRecipe.Veg.veg,DNRecipe.NonVeg.nveg,DNRecipe.Veg,DNRecipe.NonVeg modules
    ...
    import pandas as pd
    import DNRecipe.Veg.veg as veg
    import string
    import DNRecipe.NonVeg.nveg as nveg
    from DNRecipe.Veg import easy as e,intermediate as i,difficult as d 
    from DNRecipe.NonVeg import easy as ne,intermediate as ni,difficult as nd
